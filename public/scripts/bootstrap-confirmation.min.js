...
+function (a) {
    ...
    var b = !1, c = function (c, d) {
        ...
        this.init("confirmation", c, d), a(c).on("show.bs.confirmation", function (b) {
            ...
            var c = e.options, d = c.all_selector;
    ...
    c.VERSION = "1.0.5", c.DEFAULTS = a.extend({}, a.fn.popover.Constructor.DEFAULTS, {
        ...
        var b = this, c = this.tip(), d = this.getTitle(), e = c.find('[data-apply="confirmation"]'), f = c.find('[data-dismiss="confirmation"]'), g = this.options;
    ...
    a.fn.confirmation = function (b) {
        ...
        return this.each(function () {
            var e = a(this), f = e.data("bs.confirmation"), g = "object" == typeof b && b;
